...
def evaluate_test(model, setpath='datasets/Youku/Youku/train/HR', difficulty='easy', name='evaluate'):
    ...
    lr_resize.save("datasets/Youku/Youku/images/" + name + "_lr.jpg")
    sr.save("datasets/Youku/Youku/images/SR/" + name + "_sr.jpg")
    hr.save("datasets/Youku/Youku/images/SR/" + name + "_hr.jpg")
    pass
